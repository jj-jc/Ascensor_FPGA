...
HD_PWD='C:/Users/juanj/Desktop/REPOSITORIO SED/Trabajo_V1.0/Trabajo_V1.0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Display_refresh.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Display_refresh.tcl -notrace
